...
likeability.users_vote field. The other main field of the Likeability class is the creativity 
...
class Likeability(models.Model): 
    ...
    class Meta:
        unique_together = ('creativity', 'users_vote',) # one row, one user enters / modifies choice to one category card     
